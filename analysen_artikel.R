...
mca_studieninteresse <- MCA(datensatz_studieninteresse_imputiert$completeObs, graph = FALSE, excl = c(24, 28, 32,36))
...
fviz_gda_conc_ellipse(mca_studieninteresse)
...
fviz_gda_quali_ellipses(mca_studieninteresse, alter, "alter", 
  ...
  designate_axes(0.75, 0.06, c("Teilzeit", "Vollzeit")) +
  designate_axes(0.05, -0.6, c("Selbsttätigkeit", "Unterstützung"), rotate = TRUE)
ggsave("Alter.pdf", width = 10, height = 6)

fviz_gda_quali_supvar(mca_studieninteresse, alter, "alter", path = TRUE) +
  designate_axes(0.75, 0.009, c("Teilzeit", "Vollzeit")) +
  designate_axes(0.05, -0.15, c("Selbsttätigkeit", "Unterstützung"), rotate = TRUE)
...
fviz_gda_quali_ellipses(mca_studieninteresse, berufsgruppe, "beruf") +
...
fviz_gda_quali_supvar(mca_studieninteresse, berufsgruppe, "beruf", path = TRUE,
  ...
  designate_axes(0.75, 0.008, c("Teilzeit", "Vollzeit")) +
  designate_axes(0.03, -0.04, c("Selbsttätigkeit", "Unterstützung"), rotate = TRUE)
...
fviz_gda_quali_supvar(mca_studieninteresse, gruende, "grund_1", path = TRUE) +
  designate_axes(0.75, 0.05, c("Teilzeit", "Vollzeit")) +
  designate_axes(0.05, -0.5, c("Selbsttätigkeit", "Unterstützung"), rotate = TRUE)
